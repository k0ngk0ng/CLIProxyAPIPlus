...
//
// Supported channels: gemini-cli, vertex, aistudio, antigravity, claude, codex, qwen, iflow, kiro, kilo, github-copilot, kimi.
func OAuthModelAliasChannel(provider, authKind string) string {
	...
	case "codex":
		...
		return "codex"
	case "gemini-cli", "aistudio", "antigravity", "qwen", "iflow", "kiro", "kilo", "github-copilot", "kimi":
		return provider
	default:
		return ""
	}
